...
create table Board(board_post_idx number PRIMARY key, board_user_id VARCHAR2(50), FOREIGN KEY (board_user_id) REFERENCES users(USER_ID),board_title VARCHAR2(200), board_content VARCHAR2(4000), board_image VARCHAR2(400), board_resigster_date date, board_update_date date, board_ip VARCHAR2(50), board_count number
